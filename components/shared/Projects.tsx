...
export const Projects = () => {
  return (
    <SlideIn direction="bottom">
      <div className="font-sans relative z-10 mt-10">
        ...
        <div className="card-container px-4 lg:px-8">
          {projectData.map((project, index) => (
            <div
              key={index}
              className="card md:sticky lg:sticky pb-20 md:pb-0 border border-white/10 md:max-w-4xl lg:max-w-6xl mx-auto bg-white/5 backdrop-blur-md rounded-3xl my-14 cursor-pointer hover:shadow-[0_0px_20px_0_rgba(255,255,255,0.05)] transition-all duration-300"
